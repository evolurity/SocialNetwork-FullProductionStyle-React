...
describe('articleDetailsSlice.test', () => {
    test('test fetch article service pending', () => {
        ...
        expect(articleDetailsReducer(state as ArticleDetailsSchema, fetchByArticleId.pending)).toEqual(
    ...
    test('test fetch article service fulfilled', () => {
        ...
        expect(articleDetailsReducer(state as ArticleDetailsSchema, fetchByArticleId.fulfilled(data as Article, '', ''))).toEqual(
            {
